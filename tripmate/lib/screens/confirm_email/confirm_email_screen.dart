...
import 'package:tripmate/screens/confirm_email/controller/confirm_password_controller.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GetBuilder<ConfirmPasswordController>(
          init: ConfirmPasswordController(email),
          builder: (ConfirmPasswordController controller) => SafeArea(
              child: Column(
            children: [
              Gap(height * 0.3),
              Text(
